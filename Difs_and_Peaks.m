function [ PKS_ov05LOCS, Sig1Filter_PKS_ov05, R_R_Interval ] = Peaks_and_RR( Y, X1 )
...
PeakTHD = 0.5; %Didnt get threshold windowing working proprely, so 
 ...
 MinWidth = 0.01;
 MinDist = 0.3
 [Sig1Filter_PKS_ov05,PKS_ov05LOCS] = findpeaks(Y, X1, 'MinPeakHeight',PeakTHD, 'MinPeakWidth', MinWidth, 'MinPeakDistance',MinDist); %COUNT PEAKS THAT ARE OVER threshold;
